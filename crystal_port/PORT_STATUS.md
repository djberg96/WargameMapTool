...
- sketch-layer editing parity beyond shape-mode creation plus move/resize/rotate/copy/snap basics, basic selected-sketch inspector editing, and project persistence
