...
- explicit asset selection via canvas clicks when the Asset tool is active, with add/drag-move/replace-image/delete actions and inspector-based scale, rotation, and opacity editing
...
- asset-layer editing parity beyond basic create/select/move/replace/delete actions, inspector editing of core object properties, fallback rendering, and slice-state persistence
