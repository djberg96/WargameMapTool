...
- object-backed sketch layer with `.hexmap`/slice persistence, imported shape rendering, click-select, drag-move, right-click/Delete removal, drag-to-create rectangle sketches in the Sketch tool, and inspector-based stroke/fill/rotation/draw-over-grid editing for the selected sketch
...
- sketch-layer editing parity beyond imported-shape rendering, rectangle creation, selection/move/remove, basic selected-sketch inspector editing, and project persistence
