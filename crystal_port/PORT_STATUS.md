...
- object-backed path layer with explicit Path-tool selection, inspector-based width/color/line-style/opacity editing, duplicate/delete actions, and Crystal slice JSON persistence
...
- the advanced paint, fill, path creation, path geometry editing, border, hexside, and text tool behaviors
