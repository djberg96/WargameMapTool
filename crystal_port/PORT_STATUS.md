...
- object-backed path layer with explicit Path-tool selection, two-click path creation, preview feedback, inspector-based width/color/line-style/opacity editing, duplicate/delete actions, and Crystal slice JSON persistence
...
- the advanced paint, fill, path geometry editing, border, hexside, and text tool behaviors
