...
- object-backed sketch layer with `.hexmap`/slice persistence, imported shape rendering, click-select, drag-move, right-click/Delete removal, drag-to-create line/rectangle/polygon/ellipse/freehand sketches in the Sketch tool, creation-mode controls for shape/sides/closed/perfect-circle defaults, and inspector-based stroke/fill/rotation/draw-over-grid editing for the selected sketch
...
- sketch-layer editing parity beyond shape-mode creation basics, selection/move/remove, basic selected-sketch inspector editing, and project persistence
