...
- minimal terrain fill workflow with per-hex color overrides, left-drag paint, right-drag clear, inspector fill color control, and Crystal slice JSON persistence
