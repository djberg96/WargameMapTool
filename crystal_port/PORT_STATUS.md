...
- object-backed path layer with explicit Path-tool selection, inspector-based width/line-style/opacity editing, duplicate/delete actions, and Crystal slice JSON persistence
