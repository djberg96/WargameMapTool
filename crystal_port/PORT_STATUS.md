...
- object-backed sketch layer with `.hexmap`/slice persistence, imported shape rendering, click-select, drag-move, corner-handle resize, rotation-handle editing, sketch copy/paste duplication, right-click/Delete removal, drag-to-create line/rectangle/polygon/ellipse/freehand sketches in the Sketch tool, creation-mode controls for shape/sides/closed/perfect-circle/snap defaults, snapped select-mode move/resize interactions, and inspector-based stroke/fill/rotation/draw-over-grid editing for the selected sketch
...
- snapshot-based undo/redo across the current canvas, menu, and inspector edit paths
...
- sketch-layer editing parity beyond shape-mode creation plus move/resize/rotate/copy/snap basics, deeper selected-sketch inspector editing, and project persistence
